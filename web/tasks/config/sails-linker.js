...
module.exports = function(grunt) {
  ...
  grunt.config.set('sails-linker', {
    ...
    devTpl: {
      ...
      files: {
        '.tmp/public/index.html': ['.tmp/public/jst-' + version + '.js'],
        'views/**/*.html': ['.tmp/public/jst-' + version + '.js'],
        'views/**/*.ejs': ['.tmp/public/jst-' + version + '.js']
      }
    },
    ...
    prodJsJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/min/production-' + version + '.min.js']
      }
    },
    ...
    prodStylesJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/min/production-' + version + '.min.css']
      }
    },
    ...
    devTplJade: {
      ...
      files: {
        'views/**/*.jade': ['.tmp/public/jst-' + version + '.js']
      }
    }
  });
